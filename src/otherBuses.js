...
// 東京バス路線データ（GTFS時刻表のバス停名と一致させること）
const TOKYO_BUS_ROUTES = [
  {
    id: 'TK01',
    name: '国際通り糸満線',
    company: '東京バス',
    stops: ['糸満市役所', '琉球ホテル＆リゾート名城ビーチ', '道の駅いとまん', '赤嶺駅', '那覇空港', '那覇商業高校（松山入口）', '国際通り入口'],
  },
  {
    id: 'TK02',
    name: 'ウミカジライナー',
    company: '東京バス',
    stops: ['国際通り入口', '那覇商業高校（松山入口）', '那覇空港', '赤嶺駅', '瀬長島ホテル ウミカジテラス', '瀬長島ホテル　ウミカジテラス', 'ストーリーライン瀬長島', 'あしびなー前', 'イーアス沖縄豊崎', '道の駅いとまん', 'サザンビーチホテル＆リゾート沖縄', '糸満市役所', '琉球ホテル＆リゾート名城ビーチ'],
  },
  {
    id: 'TK03',
    name: '名城ビーチリゾートライナー',
  ...
  },
  {
    ...
    name: '瀬長島リムジン',
    company: '東京バス',
    stops: ['那覇空港', '瀬長島ホテル ウミカジテラス', '瀬長島ホテル　ウミカジテラス', 'ストーリーライン瀬長島', 'イーアス沖縄豊崎'],
  },
  {
    id: 'TK05',
    name: '北谷ゲートウェイライナー',
    company: '東京バス',
    stops: ['那覇空港', '国際通り入口', '壺川駅', '赤嶺駅', '瀬長島ホテル ウミカジテラス', '瀬長島ホテル　ウミカジテラス', 'ストーリーライン瀬長島', 'あしびなー前', 'イーアス沖縄豊崎', '道の駅いとまん', 'サザンビーチホテル＆リゾート沖縄', '糸満市役所', '琉球ホテル＆リゾート名城ビーチ', '北谷ゲートウェイ'],
    fwdNoAlight: ['国際通り入口'],
    revNoBoard: ['国際通り入口'],
  },
  {
    ...
    name: 'ジャングリアエクスプレス',
    company: '東京バス',
    stops: ['那覇空港', '国際通り入口', 'ジャングリア沖縄'],
  },
];

// やんばる急行バス路線データ（GTFS時刻表のバス停名と一致させること）
const YANBARU_ROUTES = [
  {
    ...
    stops: [
      ...
      '旧「第一渡喜仁」バス停', '旧「第二渡喜仁」バス停', '旧「第三渡喜仁」バス停',
      'ウッパマビーチ付近', 'リゾートホテル・ベル・パライソ',
      '旧「リゾートステーション前」バス停', '旧「上運天」バス停', '旧「徳山入口」バス停',
      '運天港',
    ],
  },
  {
    ...
    company: 'やんばる急行バス',
    stops: [
      '今帰仁城跡', '北山病院付近', '今帰仁城跡入口', '仲尾次（北山高校）',
      '今帰仁村役場', '仲宗根', '天底公民館',
      'DRIVE IN リカリカワルミ', '運天原', '古宇利大橋南詰展望所付近',
      '古宇利大橋のまんなか付近', '古宇利島の駅ソラハシ',
      '人類発祥の島碑付近', 'スルル洞入口付近',
      'トケイ浜・ハートロック', '古宇利オーシャンタワー',
    ],
  },
  {
    id: 'YKB-HLT',
    name: 'やんばる急行バス（ヒルトン瀬底）',
    company: 'やんばる急行バス',
    stops: ['那覇空港', 'ヒルトン沖縄瀬底リゾート'],
  },
];

// カリー観光路線データ（沖縄本島のみ、石垣島路線は除外）
// GTFS時刻表のバス停名と一致させること
const KARRY_ROUTES = [
  {
    id: 'KR853',
    name: '北谷ライナー（空港→北谷）',
    company: 'カリー観光',
    stops: ['那覇空港', '県庁北口', 'とまりん前（泊高橋）', 'おもろまち駅前', 'おもろまち一丁目', 'コンベンションセンター前', '沖縄プリンスホテル', '北谷ゲートウェイ'],
  },
  {
    id: 'KR854',
    name: '北谷ライナー（北谷→空港）',
    company: 'カリー観光',
    stops: ['北谷ゲートウェイ', '沖縄プリンスホテル', 'コンベンションセンター前', 'とまりん前（泊高橋）', '旭橋', '那覇空港'],
  },
  {
    id: 'KR797',
    name: 'パルコシティシャトル（メインプレイス→パルコ）',
    company: 'カリー観光',
    stops: ['おもろまち一丁目', 'おもろまち駅前', 'サンエーパルコシティ'],
  },
  {
    id: 'KR798',
    name: 'パルコシティシャトル（パルコ→メインプレイス）',
    company: 'カリー観光',
    stops: ['サンエーパルコシティ', 'おもろまち一丁目', 'おもろまち駅前'],
  },
];

// 沖縄エアポートシャトル路線データ（GTFS時刻表のバス停名と一致させること）
const AIRPORT_SHUTTLE_ROUTES = [
  {
    id: 'OAS-APL',
    name: 'エアポートライナー',
    company: '沖縄エアポートシャトル',
    stops: ['那覇空港', '那覇空港国内線', '那覇空港国際線', '旭橋駅・那覇バスターミナル前', 'おんなの駅（なかゆくい市場前）', 'タイガービーチ前', 'サンマリーナビーチ前', 'ナビービーチ前', 'ハレクラニ沖縄前（伊武部希望ヶ丘入口）', 'かりゆしビーチ前', '名護市役所前', '本部港', '沖縄美ら海水族館（記念公園前）', 'ホテルオリオンモトブリゾート＆スパ', '備瀬フクギ並木入口'],
  },
  {
    id: 'OAS-RSL',
    name: 'リゾートライナー',
    company: '沖縄エアポートシャトル',
    stops: ['那覇空港', '那覇空港国内線', '那覇空港国際線', '県庁北口', 'おんなの駅（なかゆくい市場前）', 'タイガービーチ前', 'サンマリーナビーチ前', 'ナビービーチ前', 'ハレクラニ沖縄前（伊武部希望ヶ丘入口）', 'かりゆしビーチ前', '名護市役所前', '本部港', '沖縄美ら海水族館（記念公園前）', 'エメラルドビーチ前', '備瀬フクギ並木入口'],
  },
  {
    id: 'OAS-RSL-RP',
    name: 'リゾートライナー特急',
    company: '沖縄エアポートシャトル',
    stops: ['那覇空港', '那覇空港国内線', '那覇空港国際線', '県庁北口', '名護市役所前', '沖縄美ら海水族館（記念公園前）', 'エメラルドビーチ前', '備瀬フクギ並木入口'],
  },
];
